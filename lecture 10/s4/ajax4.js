$(function() {
	...
	$("#button").click(function() {
		...
		clickLittleCircus(arr[0], function(err) {
			clickLittleCircus(arr[1], function(err) {
				clickLittleCircus(arr[2], function(err) {
					clickLittleCircus(arr[3], function(err) {
						clickLittleCircus(arr[4], function(err) {
							sumCount();
						});
					});
				});
